...
void StateLevel2::ReadInventoryEquipment(const char* name, uking::ui::PouchItem* pItem, util::NamedValue<u32, 64>& value){
...
void StateLevel2::WriteInventoryEquipment(const char* name, uking::ui::PouchItem* pItem, const util::NamedValue<u32, 64>& value) {
    if(mem::PtrLooksSafe(pItem)){ 
...
void StateLevel2::ReadOverworldEquipment(const char* name, const mem::SafePtr<ksys::act::BaseProc>& safepActor, const mem::SafePtr<u32>& safepDurability, util::NamedValue<u32, 64>& value){
...
void StateLevel2::WriteOverworldEquipment(const char* name, const mem::SafePtr<ksys::act::BaseProc>& safepActor, const mem::SafePtr<u32>& safepDurability,const util::NamedValue<u32, 64>& value){
    ksys::act::BaseProc* pActor;
    if (safepActor.TakePtr(&pActor)){
...
void StateLevel2::ReadFromGame() {
    ...
    if(TakePtrOrError(named(mem::SafePtr(uking::ui::PauseMenuDataMgr::instance())), &pPauseMenuDataMgr)){
        ...
        ReadInventoryEquipment("arrow", pPauseMenuDataMgr->getEquippedWeapon(uking::ui::PouchItemType::Arrow), mMenuEquippedArrow);
        ReadInventoryEquipment("weapon", pPauseMenuDataMgr->getEquippedWeapon(uking::ui::PouchItemType::Sword), mMenuEquippedWeapon);
        ReadInventoryEquipment("bow", pPauseMenuDataMgr->getEquippedWeapon(uking::ui::PouchItemType::Bow), mMenuEquippedBow);
        ReadInventoryEquipment("shield", pPauseMenuDataMgr->getEquippedWeapon(uking::ui::PouchItemType::Shield), mMenuEquippedShield);
    }

    ReadOverworldEquipment("weapon", mem::GamePtr::OverworldWeaponActor(), mem::GamePtr::OverworldWeaponDurability(), mOverworldEquippedWeapon);
    ReadOverworldEquipment("bow", mem::GamePtr::OverworldBowActor(), mem::GamePtr::OverworldBowDurability(), mOverworldEquippedBow);
    ReadOverworldEquipment("shield", mem::GamePtr::OverworldShieldActor(), mem::GamePtr::OverworldShieldDurability(), mOverworldEquippedShield);
}
...
void StateLevel2::WriteToGame() {
    ...
    if(TakePtrOrError(named(mem::SafePtr(uking::ui::PauseMenuDataMgr::instance())), &pPauseMenuDataMgr)){
        ...
        WriteInventoryEquipment("arrow", pPauseMenuDataMgr->getEquippedWeapon(uking::ui::PouchItemType::Arrow), mMenuEquippedArrow);
        WriteInventoryEquipment("weapon", pPauseMenuDataMgr->getEquippedWeapon(uking::ui::PouchItemType::Sword), mMenuEquippedWeapon);
        WriteInventoryEquipment("bow", pPauseMenuDataMgr->getEquippedWeapon(uking::ui::PouchItemType::Bow), mMenuEquippedBow);
        WriteInventoryEquipment("shield", pPauseMenuDataMgr->getEquippedWeapon(uking::ui::PouchItemType::Shield), mMenuEquippedShield);
    }
    

    WriteOverworldEquipment("weapon", mem::GamePtr::OverworldWeaponActor(), mem::GamePtr::OverworldWeaponDurability(), mOverworldEquippedWeapon);
    WriteOverworldEquipment("bow", mem::GamePtr::OverworldBowActor(), mem::GamePtr::OverworldBowDurability(), mOverworldEquippedBow);
    WriteOverworldEquipment("shield", mem::GamePtr::OverworldShieldActor(), mem::GamePtr::OverworldShieldDurability(), mOverworldEquippedShield);
